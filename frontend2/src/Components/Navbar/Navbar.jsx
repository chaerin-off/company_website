    ...
    <nav className="fixed top-0 left-0 w-full bg-white text-black p-4 shadow-lg z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <select
          ...
          className="hidden lg:block px-3 py-1 ml-8 border rounded-md bg-white hover:border-green-500 transition duration-300"
        >
      ...
      >
        <div className="p-4">
          ...
          <select
            value={language}
            onChange={(e) => setLanguage(e.target.value)}
            className="mt-6 w-full px-3 py-1 border rounded-md bg-white hover:border-green-500 transition duration-300"
          >
            <option value="ko">한국어</option>
            <option value="en">English</option>
          </select>
