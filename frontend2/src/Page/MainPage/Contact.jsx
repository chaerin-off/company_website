...
const Contact = () => {
  return (
    <div className="bg-white py-29 lg:py-48">
      {/*문의하기 페이지의 컴포넌트(문의하기 제목/문의처 내용/구글맵/문의하기 버튼)의
      레이아웃은 container로 설정*/}
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/*문의처 내용 컴포넌트의 레이아웃은 grid로 설정.
        화면이 md 사이즈 이상일 때는 3개의 열을 일렬로 설정함*/}
