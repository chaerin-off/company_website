  ...
  return (
    <div>
      ...
      <div className="text-center">
        <h2 className="text-3xl text-bold text-gray-800 mt-6 mb-12">
          왜 우리를 선택해야 될까요?
        </h2>
      ...
      <div className="mt-40">
        <h2 className="text-3xl text-bold text-gray-800 text-center mb-16">
          프로젝트 진행 프로세스
        </h2>
      ...
      <div className="mt-32 bg-blue-600 rounded-2xl p-12 text-center mx-20 my-20 text-white">
        ...
        <button className=" text-blue-600 bg-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300">
          무료 상담 신청하기
        </button>
      </div>
    </div>
