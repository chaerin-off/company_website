...
const Leadership = () => {
  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-32">
      ...
      {/*flex 레이아웃을 선언하여 PC 버전에선 가로 나열, 모바일 버전에선 세로 나열*/}
        ...
        <div className="md:w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              ...
              <p className="text-green-600">대표이사</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-24">
        ...
        {/*grid 레이아웃을 사용해 모바일 버전에선 1개의 카드, 중간 버전에선 2개의 카드, PC 버전에선 4개의 카드가 보이도록 함*/}
          ...
          {executives.map((executive, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-green-600 font-semibold mb-4">{executive.position}</p>
          ...
          {teamMembers.map((teamMember, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-green-600 font-semibold mb-4">{teamMember.position}</p>
